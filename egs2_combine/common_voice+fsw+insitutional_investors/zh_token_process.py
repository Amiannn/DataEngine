...
if __name__ == '__main__':
    path = "./egs2_combine/common_voice+fsw+insitutional_investors/tokens/token.man.1"
    ...
    output_path = os.path.join('./egs2_combine/common_voice+fsw+insitutional_investors/tokens/', 'token.man.2')
