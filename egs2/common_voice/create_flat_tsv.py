...
def main(wav_path, root_path, output_path):
    ...
    for utt in datas:
        ...
        path = wav_datas[utt]
        _utt = utt.replace('-', '_')
        _datas[utt] = [_utt, _utt, text, path]
...
if __name__ == '__main__':
    ...
    root_path   = '/share/nas165/amian/datasets/cv-corpus-11.0-2022-09-21/zh-TW/dev.tsv'
    output_path = './egs2/common_voice/tsv/dev.tsv'
