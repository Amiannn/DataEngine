...
if __name__ == '__main__':
    path = "./egs2/esun_investor_various/tokens/token.man.1"
    path = "/share/nas165/amian/experiments/nlp/SubCharTokenization/zh_aishell_3000_bpe.vocab"
    ...
    output_path = os.path.join('./egs2/esun_investor_various/tokens_ws', 'token.man.2')
