...
if __name__ == '__main__':
    root_path   = '/share/nas165/amian/experiments/speech/preprocess/dataset_pre/egs2/earning22/dump'
    output_path = './egs2/earning22/data'

    output_scp_path = './egs2/earning22/dump'
