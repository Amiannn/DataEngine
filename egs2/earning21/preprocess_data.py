...
if __name__ == '__main__':
    wav_folder             = '/share/nas165/amian/experiments/speech/preprocess/dataset_pre/egs2/earning21/data/wav_16k'
    earning_utterance_path = './egs2/earning21/data/earning21_utterances.json'
    output_folder          = './egs2/earning21/dump'
